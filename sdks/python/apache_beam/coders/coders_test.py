...
class CodersTest(unittest.TestCase):
  ...
  def test_str_utf8_coder(self):
    real_coder = coders_registry.get_coder(six.text_type)
    expected_coder = coders.StrUtf8Coder()
    self.assertEqual(real_coder.encode(u'abc'), expected_coder.encode(u'abc'))
    self.assertEqual(u'abc', real_coder.decode(real_coder.encode(u'abc')))
    self.assertIsInstance(real_coder.decode(real_coder.encode(u'abc')),
                          six.text_type)
